...
public class Program {
	...
	public static void main(String[] args) {
		//	아래 부품 생성, 부품 조립 과정을 spring이 하도록 지시 필요
		//	그래서 지시서 setting.xml 작성 필요
		...
		//ExamConsol console = new GridExamConsole();	//	부품 생성 (객체 생성)
													//	Exam : interface
													//	NewlecExam : 구현체
		ExamConsol console = new GridExamConsole();	//	부품 조립 결합
														//	1. 생성자로 결합
	...
	ApplicationContext context = new 
		//	ApplicationContex :	DI 지시서를 읽고 생성, 조립하는 객체
		//							Interface
		//	ClassPathXmlApplicationContex :	ApplicationContext 인터페이스를 구현하는 클래스 종류
		//										1.	ClassPathXmlApplication
		//										2.	FileSystemXmlApplication
		//										3.	XmlWebApplication
		//										4.	AnnotationConfigApplication
		//	context	:	spring이 지시서를 보고 생성한 객체들을 담는 컨테이너
		//				IOC 컨테이너
